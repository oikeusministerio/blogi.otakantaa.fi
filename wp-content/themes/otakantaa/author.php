...
get_header(); ?>
		...
		<section id="primary">
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php endif; ?>
				<?php 
				// Show "Connect me in Facebook" link
				if (function_exists('vmfb_get_user_facebook_profile_link')) {
					$link = vmfb_get_user_facebook_profile_link(get_the_author_meta('ID'));
					if ($link)
						echo '<div class="author-meta">'.$link.'</div>';	
				}
				?>
				</div>
