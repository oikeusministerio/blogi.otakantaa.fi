...
class timthumb {
	...
	protected function getLocalImagePath($src){
		...
		if(file_exists ($this->docRoot . '/' . $src)) {
			...
			// Verkkomuikku - bug fix, doesn't realize that the home/www is symlink to var/www
			// if(strpos($real, $realDocRoot) === 0){
			$verkkomuikku_local_host = strpos($real, '/home/teemu');
			if(strpos($real, $realDocRoot) === 0 || $verkkomuikku_local_host === 0){
				return $real;
			} else {
