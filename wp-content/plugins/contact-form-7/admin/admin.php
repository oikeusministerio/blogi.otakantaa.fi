...
function wpcf7_admin_menu() {
	...
	// Osallistumisymparisto, verkkomuikku, changed capability for the page
	// to not display the contact forms for authors
	add_object_page( __( 'Contact Form 7', 'wpcf7' ), __( 'Contact', 'wpcf7' ),
		'wpcf7_edit_contact_forms', 'wpcf7', 'wpcf7_admin_management_page',
